...
public class CsvFileWriter {
	...
	public static void csv_sauna(Sauna sauna) throws IOException {
		String fileName="sauna.csv";
	...
	public static void csv_zimmer(Zimmer zimmer) throws IOException {
		String fileName="zimmer.csv";
		
			FileWriter fileWriter = new FileWriter(fileName,true);
			
			fileWriter.append(COMMA_DELIMITER);
			fileWriter.append(zimmer.getVorname());
			fileWriter.append(COMMA_DELIMITER);
			fileWriter.append(zimmer.getNachname());
			fileWriter.append(COMMA_DELIMITER);
			fileWriter.append(zimmer.getSteuernummer());
			fileWriter.append(COMMA_DELIMITER);
